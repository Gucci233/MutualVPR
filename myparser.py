...
def parse_arguments(is_training: bool = True):
    ...
    parser.add_argument("--C", type=int, default=6, help="_")
    ...
    parser.add_argument("--backbone", type=str, default="DinoV2",
                        choices=["DinoV2","VGG16","ResNet18", "ResNet50", "ResNet101", "ResNet152",], help="_")
    ...
    parser.add_argument("--resize_test_imgs", default=True, action="store_true",
    ...
    parser.add_argument("--test_set_folder", type=str, 
